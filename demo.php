...
foreach($arrresultado as $i=>$valor){
    ...
    $titulopagina = "Demo - ".$compania_nombre;
    $descripcionpagina = "Demo - $compania_nombre ";
...
<head>
  ...
  <title><?php echo $compania_nombre;?> - Demo</title>
    ...
    <section id="hero" class="contact">
      <div class="container">
        ...
        <div class="section-title">
          ...
          <p> Envianos tu solicitud y a la brevedad te haremos llegar un demo para que pruebes nuestro servicio</p>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            <div class="row">
              ...
              <div class="col-lg-12 info" data-aos="fade-up" data-aos-delay="200" style="padding: 130px 60px;">
          ...
          <div class="col-lg-6">
            <form action="demo.php" method="post" class="php-email-form">
              <div class="form-group">
                <input placeholder="Nombre y Apellido" type="text" name="name" class="form-control" id="name" data-rule="" data-msg="" required="required" />
                <div class=""></div>
              </div>
              <div class="form-group">
                <input placeholder="Email" type="email" class="form-control" name="email" id="email" data-rule="email" data-msg="Por favor ingresar un email valido" required="required" />
                <div class=""></div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <input placeholder="Pais" type="text" class="form-control" name="pais" id="pais" data-rule="" data-msg="" />
                <div class=""></div>
              </div>
              <div class="form-group">
                <input placeholder="Servicio que ofreces" type="text" class="form-control" name="servicio" id="servicio" data-rule="" data-msg="" />
                <div class=""></div>
              </div>
              <div class="form-group">
                <textarea placeholder="Describe el servicio que presta tu negocio" class="form-control" name="message" rows="3" data-rule="required" data-msg=""></textarea>
                <div class=""></div>
              </div>
